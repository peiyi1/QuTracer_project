##This code is from Mapomatic with minor modifications to track the mapping by Peiyi Li, (pli11@ncsu.edu)
#The Mapomatic code is under the following license:
...
def deflate_circuit(input_circ):
    ...
    """
    #pli11: add initial_virtual_layout_map to track the mapping
    layout = input_circ._layout
    initial_virtual_layout=layout.initial_virtual_layout(filter_ancillas=True)
    #print(initial_virtual_layout)
    initial_virtual_layout_map = {}
    ...
    for idx, val in enumerate(
        ...
        #pli11: update initial_virtual_layout_map
        if val.index in initial_virtual_layout._v2p.values():
            logical_qubit=initial_virtual_layout[val.index]
            initial_virtual_layout_map[logical_qubit] = idx
    ...
    return new_qc,initial_virtual_layout_map
