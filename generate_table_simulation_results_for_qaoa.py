...
labels = ['qaoa_reps1_n10', 'qaoa_reps2_n10','qaoa_reps3_n10','qaoa_reps4_n10','qaoa_reps5_n10',]
    

with open('simulation_results_for_qaoa.csv', 'w') as csvfile:
    ...
    for name in labels:
        ...
        save_path ='./test_on_simulator/saved_data/' + name
