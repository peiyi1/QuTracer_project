...
if(configuration['QuTracer_cutting_qubits']==1):
    ...
    from ResultsProcessing.QuTracer_cutting_one_qubit import obtain_counts_dict_based_on_previous_layer_info,obtain_meas_prep_trace_dict_layer_n,obtain_density_matrix_pcs_layer_n
else:
    ...
    from ResultsProcessing.QuTracer_cutting_two_qubit import obtain_counts_dict_based_on_previous_layer_info,obtain_meas_prep_trace_dict_layer_n,obtain_density_matrix_pcs_layer_n
##########################################################################
